...
# user2.save
user3 = User.create!(first_name: "Steve", last_name: "McMaony", password: '123456', email: "Steve@gmail.com", international_client: InternationalClient.all.sample)
user3.profile_picture = "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80"
# user3.save
