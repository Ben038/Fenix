...
international_client1 = InternationalClient.create!(name: "HO 1")
international_client2 = InternationalClient.create!(name: "HO 2")
...
user1 = User.create!(first_name: "Elizabeth", last_name:"Delacroix", password: '123456', email: "test1@gmail.com", international_client_id: )
...
user1.save
user2 = User.create!(ffirst_name: "John", last_name: "Robinson", password: '123456', email: "test2@gmail.com", international_client_id: )
...
user2.save
user3 = User.create!("Steve", last_name: "McMaony", password: '123456', email: "test3@gmail.com", international_client_id: )
